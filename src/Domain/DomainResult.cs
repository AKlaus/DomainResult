...
namespace AK.DomainResults.Domain
{
	public class DomainResult : ErrorDetails
	{
		...
		public DomainResult(DomainOperationStatus status, string error) : base(status, new[] { error }) { }
	...
	public class DomainResult<TValue> : Tuple<TValue, ErrorDetails>, IDomainResult<TValue>
	{
		...
		public DomainResult(DomainOperationStatus status, string error) : this(status, new[] { error }) { }
