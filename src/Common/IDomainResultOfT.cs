...
namespace DomainResults.Common
{
	...
	public interface IDomainResult<T> : IDomainResultBase
	{
		...
		/// </summary>
		/// <param name="message"> Optional message </param>
		static IDomainResult<T> PayloadTooLarge(string? message = null)	=> DomainResult<T>.PayloadTooLarge(message);
		...
		/// </summary>
		/// <param name="message"> Optional message </param>
		static Task<IDomainResult<T>> PayloadTooLargeTask(string? message = null)	=> DomainResult<T>.PayloadTooLargeTask(message);
