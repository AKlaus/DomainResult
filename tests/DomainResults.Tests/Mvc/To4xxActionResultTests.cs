...
public class To_4xx_ActionResult_Tests
{
	...
	public static readonly IEnumerable<object[]> FailedResultWithValueCases = TestCases(DomainResult.Failed<int>, DomainResult.NotFound<int>, DomainResult.Unauthorized<int>, DomainResult.Conflict<int>, DomainResult.PayloadTooLarge<int>, DomainResult.CriticalDependencyError<int>);
	...
	public static readonly IEnumerable<object[]> FailedResultWithValueTaskCases = TestCases(DomainResult.FailedTask<int>, DomainResult.NotFoundTask<int>, DomainResult.UnauthorizedTask<int>, DomainResult.ConflictTask<int>, DomainResult.PayloadTooLargeTask<int>, DomainResult.CriticalDependencyErrorTask<int>);
	...
	public static readonly IEnumerable<object[]> FailedResultCases = TestCases(DomainResult.Failed, DomainResult.NotFound, DomainResult.Unauthorized, DomainResult.Conflict, DomainResult.PayloadTooLarge, DomainResult.CriticalDependencyError);
	...
	public static readonly IEnumerable<object[]> FailedResultTaskCases = TestCases(DomainResult.FailedTask, DomainResult.NotFoundTask, DomainResult.UnauthorizedTask, DomainResult.ConflictTask, DomainResult.PayloadTooLargeTask, DomainResult.CriticalDependencyErrorTask);
	...
	public static readonly IEnumerable<object[]> FailedValueTestCases = TestCases(DomainResult.Failed, DomainResult.NotFound, DomainResult.Unauthorized, DomainResult.Conflict, DomainResult.PayloadTooLarge, DomainResult.CriticalDependencyError, v => (10, v));
	...
	public static readonly IEnumerable<object[]> FailedValueTaskTestCases = TestCases(DomainResult.Failed, DomainResult.NotFound, DomainResult.Unauthorized, DomainResult.Conflict, DomainResult.PayloadTooLarge, DomainResult.CriticalDependencyError, v => Task.FromResult((10, v)));
	...
	/// <param name="domainPayloadTooLargeFunc"> The <see cref="DomainOperationStatus.PayloadTooLarge"/> function </param>
	...
	private static IEnumerable<object[]> TestCases<T>(
		...
		Func<string, T> domainPayloadTooLargeFunc,  
		...
		var returnValues = new List<object[]>
			{
				...
				new[] { OptionalWrapper(domainPayloadTooLargeFunc("1")),		HttpCodeConvention.PayloadTooLargeHttpCode, "The requested entity is larger than limits defined by server",   "1" },
