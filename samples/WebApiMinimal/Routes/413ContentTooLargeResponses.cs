...
internal static partial class RoutesExtension 
{
	...
	/// </summary>
	/// <remarks>
	///		Converts <see cref="Task{TResult}"/> of <see cref="IDomainResult{T}"/>, <see cref="IDomainResult{T}"/> and `(T, <see cref="IDomainResult"/>)` responses with <see cref="IDomainResult.Status"/>='ContentTooLarge' to <see cref="HttpCodeConvention.ContentTooLargeHttpCode"/>
	/// </remarks>
